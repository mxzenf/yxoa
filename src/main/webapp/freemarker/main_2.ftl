<!--Specify page [ SAMPLE ]-->
<script src="${Request.ctx}/common/js/demo/dashboard.js"></script>
                <!--Page Title-->
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
					                ...
					                <div class="panel-control">
					                    ...
					                    <div class="btn-group">
					                        ...
					                        <ul class="dropdown-menu dropdown-menu-right">
					                            <li><a href="#">链接</a></li>
					                            <li><a href="#">我要怎么办</a></li>
					                            <li><a href="#">有些事情要做</a></li>
					                            <li class="divider"></li>
					                            <li><a href="#">办理</a></li>
					                        </ul>
					                    </div>
					                </div>
					                <h3 class="panel-title">网站流量</h3>
					            </div>
					                ...
					                <div class="row pad-top">
					                    <div class="col-lg-8">
					                        <div class="media">
					                            <div class="media-left">
					                                <div class="media">
					                                    <p class="text-semibold text-main">气温</p>
					                            ...
					                            <div class="media-body pad-lft">
					                                <div class="pad-btm">
					                                    <p class="text-semibold text-main mar-no">今日访问数量</p>
					                                    <small>一些情况要发生了,一些情况要发生了,一些情况要发生了,一些情况要发生了,一些情况要发生了,一些情况要发生了,一些情况要发生了一些情况要发生了,一些情况要发生了,一些情况要发生了.</small>
					                                </div>
					                            </div>
					                        </div>
					                    </div>
					                    ...
					                    <div class="col-lg-4">
					                        ...
					                        <ul class="list-unstyled">
					                            ...
					                            <li>
					                                <div class="clearfix">
					                                    <p class="pull-left mar-no">已使用</p>
					        ...
					        <div class="row">
					            <div class="col-sm-6 col-lg-6">
					                ...
					                <div class="panel panel-success panel-colorful">
					                    <div class="pad-all">
					                        <p class="text-lg text-semibold"><i class="demo-pli-data-storage icon-fw"></i> 硬盘容量</p>
					                        <p class="mar-no">
					            ...
					            <div class="col-sm-6 col-lg-6">
					                ...
					                <div class="panel panel-info panel-colorful">
					                    <div class="pad-all">
					                        <p class="text-lg text-semibold"><i class="demo-pli-wallet-2 icon-fw"></i> 警告</p>
					                        <p class="mar-no">
					        ...
					        <div class="row">
					            <div class="col-sm-6 col-lg-6">
					                ...
					                <div class="panel panel-purple panel-colorful">
					                    <div class="pad-all">
					                        <p class="text-lg text-semibold"><i class="demo-pli-bag-coins icon-fw"></i> 已售</p>
					                        <p class="mar-no">
					                            <span class="pull-right text-bold">$764</span>
					                            	今天
					                        </p>
					            ...
					            <div class="col-sm-6 col-lg-6">
					                ...
					                <div class="panel panel-warning panel-colorful">
					                    <div class="pad-all">
					                        <p class="text-lg text-semibold"><i class="demo-pli-check icon-fw"></i> 任务进度</p>
					                        <p class="mar-no">
					...
					<div class="row">
					            ...
					            <div class="pad-ver">
					                <ul class="list-group bg-trans list-todo mar-no">
					                    <li class="list-group-item">
					                        ...
					                        <label for="demo-todolist-1"><span>这是一条新任务. <span class="label label-danger">非常着急</span></span></label>
					                    </li>
					                    <li class="list-group-item">
					                        <input id="demo-todolist-2" class="magic-checkbox" type="checkbox" checked>
					                        <label for="demo-todolist-2"><span>这是一条新任务</span></label>
					                    </li>
					                    <li class="list-group-item">
					                        <input id="demo-todolist-3" class="magic-checkbox" type="checkbox">
					                        <label for="demo-todolist-3"><span>这是一条新任务</span></label>
					                    </li>
					                    <li class="list-group-item">
					                        <input id="demo-todolist-4" class="magic-checkbox" type="checkbox">
					                        <label for="demo-todolist-4"><span>这是一条新任务 <span class="label label-warning">着急</span></span></label>
					                    </li>
					                    <li class="list-group-item">
					                        <input id="demo-todolist-5" class="magic-checkbox" type="checkbox" checked>
					                        <label for="demo-todolist-5"><span>这是一条新任务 <span class="label label-info">特殊</span></span></label>
					                    </li>
					                </ul>
					            </div>
					    ...
					    <div class="col-lg-4">
					        <div class="panel panel-trans">
					            ...
					            <div class="panel-body">
					                <div class="pad-btm">
					                    <p class="text-semibold text-main">需要我办理的任务</p>
					                ...
					                <div class="pad-btm">
					                    <p class="text-semibold text-main">我发起的任务</p>
					                    <div class="progress progress-sm">
					        ...
					        <div class="panel panel-trans">
					            <div class="pad-all">
					                <div class="media mar-btm">
					                    <div class="media-left">
					                        <img src="${Request.ctx}/common/img//profile-photos/2.png" class="img-md img-circle" alt="Avatar">
					                    </div>
					                    <div class="media-body">
					                        <p class="text-lg text-main text-semibold mar-no">#(userName)</p>
					                        <p>管理员</p>
					                    </div>
					                </div>
					                <blockquote class="bq-sm bq-open bq-close">这里是我的个性签名 , 我很懒 ,啥都没写.</blockquote>
					            </div>
					            ...
					            <!-- <div class="bord-top">
					                <ul class="list-group bg-trans bord-no">
					                    ...
					                    <li class="list-group-item list-item-sm">
					                        ...
					                        <div class="media-body">
					                            <a href="#" class="btn-link text-semibold">@朋友</a>
					                            <br>
					                            	来了一个人
					                        </div>
					                    </li>
