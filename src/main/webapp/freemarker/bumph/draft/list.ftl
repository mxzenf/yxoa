			        ...
			        <div class="col-sm-12 eq-box-sm">
			        	<div class="panel lion-fullHeight">
						    <div class="panel-body">
						        <a id="add" class="btn btn-info data-toolbar" onclick="doPjax('#(ctx)/admin/bumph/getDraftEditPage')" href="javascript:void(0);"><i class="demo-pli-add"></i> 起草</a>
...
<script>
	var col = [{
	       ...
	       formatter:function(value,row,index){
	    	   ...
	    	   if(value=='0'){//未提交
					...
					a = a + '<a class="label label-table label-success" onclick="doPjax(\''+ctx+'/admin/bumph/getDraftEditPage?id='+row.id+'\')" href="javascript:void(0);" >编辑</a>&nbsp;';
	...
	var opt = {
		    //请求方法
			   ...
			   url: ctx+"/admin/bumph/draftListData",
