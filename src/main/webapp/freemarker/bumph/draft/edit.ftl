<#include "../../pageTitleBread.ftl">
		        ...
		        <div class="panel">
		            <div class="panel-heading">
		                <h3 class="panel-title">
		                	公文起草
		                	<a href="${Request.ctx}/admin/bumph/export.shtml?id=#(o.id)" target="_blank" style="position: absolute;right: 10px">
	...
	<script>
		function save(){
			...
			var data = common_ajax.ajaxFunc("/admin/bumph/draftSave.shtml", parm, "json", null,"application/json");
			if(data.success){
				pointLion.alertMsg("保存成功!" , "success" , "small" , function(){
					doPjax(ctx+'/admin/bumph/getDraftListPage.shtml');//跳转到列表页
				});
			}
		}
		//选择主送单位
