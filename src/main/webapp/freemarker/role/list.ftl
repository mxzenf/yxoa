			        ...
			        <div class="col-sm-12 eq-box-sm">
			        	<div class="panel lion-fullHeight">
						    <div class="panel-body">
						        <a id="add" class="btn btn-info data-toolbar" onclick="doPjax('${Request.ctx}/admin/role/getEditPage.shtml')" href="javascript:void(0);"><i class="demo-pli-add"></i> 添加</a>
...
<script>
	...
	var opt = {
		    //请求方法
			   ...
			   url: ctx+"/admin/role/listData.shtml",
	...
	function del(ids){
		pointLion.confimMsg("您是否要删除所选信息 ?<br/> 点击确认进行删除 , 点击取消取消该操作",null,function(){
			//执行删除
			var data = common_ajax.ajaxFunc("/admin/role/delete.shtml",{"ids":ids}, "json", null);
			//删除结果
			if(data.success){
	...
	function giveAuth(roleid){
			var index = layer.open({
							  ...
							  btn: ['确定', '取消'], 
							  btnAlign: 'c',
							  content: ctx+'/admin/role/getGiveAuthPage.shtml?roleid='+roleid,
							  ...
							  yes: function(){
								  	...
								  	var result = common_ajax.ajaxFunc("/admin/role/changeRoleAuth.shtml",JSON.stringify({"data":data,"roleid":roleid}), "json", null,"application/json");//保存所选角色权限
								  	if(result.success){
